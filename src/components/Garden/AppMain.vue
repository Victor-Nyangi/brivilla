...
<div>
                ...
                <div class="nav__menu" id="nav-menu">
                    <ul class="nav__list">
                        ...
                        <li class="nav__item">
                          ...
                          <li class="nav__item">
                            <router-link to="/restaurant" class="nav__link">Restaurant</router-link>
                        </li>
                        <li class="nav__item">
   ...
   <main class="main">
            ...
            <section class="home" id="home">
                <img src="../../assets/img/welcome_bg.jpg" alt="" class="home__img"/>
                ...
                <div class="home__container container grid">
                    ...
                    <div class="home__info">
                        ...
                        <div class="home__info-overlay">
                            <img src="../../assets/img/swing.jpg" alt="" class="home__info-img"/>
                        </div>
                    </div>
                </div>
            </section>
                ...
                <div class="about__container container grid">
                    ...
                    <div class="about__img">
                        <div class="about__img-overlay">
                            <img src="../../assets/img/nice_bg.jpg" alt="" class="about__img-one"/>
                        </div>

                        <div class="about__img-overlay">
                            <img src="../../assets/img/the-hotel.jpg" alt="" class="about__img-two"/>
                        </div>
                    </div>
                </div>
            </section>
                ...
                <div class="discover__container container swiper-container">
                    <div class="swiper-wrapper">
                        ...
                        <div class="discover__card swiper-slide">
                            <img src="../../assets/img/fine1.jpg" alt="" class="discover__img"/>
                        ...
                        <!--==================== DISCOVER 2 ====================-->
                        <div class="discover__card swiper-slide">
                            <img src="../../assets/img/theme1.jpg" alt="" class="discover__img"/>
                            <div class="discover__data">
                        ...
                        <!--==================== DISCOVER 3 ====================-->
                        <div class="discover__card swiper-slide">
                            <img src="../../assets/img/venue.jpg" alt="" class="discover__img"/>
                            <div class="discover__data">
                ...
                <div class="experience__container container grid">
                    ...
                    <div class="experience__img grid">
                        <div class="experience__overlay">
                            <img src="../../assets/img/sitting.jpg" alt="" class="experience__img-one"/>
                        </div>

                        <div class="experience__overlay">
                            <img src="../../assets/img/white_roses.jpg" alt="" class="experience__img-two"/>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section class="place section" id="place">
                ...
                <div class="place__container container grid">
                    ...
                    <div class="place__card">
                        <img src="../../assets/img/flowers.jpg" alt="" class="place__img"/>
                    ...
                    <!--==================== PLACES CARD 2 ====================-->
                    <div class="place__card">
                        <img src="../../assets/img/theme2.jpg" alt="" class="place__img"/>
                    ...
                    <!--==================== PLACES CARD 3 ====================-->
                    <div class="place__card">
                        <img src="../../assets/img/roses.jpg" alt="" class="place__img"/>
                    ...
                    <!--==================== PLACES CARD 4 ====================-->
                    <div class="place__card">
                        <img src="../../assets/img/red-roses.jpg" alt="" class="place__img"/>
                    ...
                    <!--==================== PLACES CARD 5 ====================-->
                    <div class="place__card">
                        <img src="../../assets/img/bunches.jpg" alt="" class="place__img"/>
        ...
        <footer class="footer section">
            <div class="footer__container container grid">
                ...
                <div class="footer__rights">
                    <p class="footer__copy">&#169; 2022 Brivilla. All rigths reserved.</p>
