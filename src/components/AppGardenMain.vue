...
<div>
    <section class="showcase">
        <header id="main-header">
            <h2 class="logo">The Forest</h2>
        </header>
        <video src="../assets/garden-view.mp4" muted loop autoplay></video>
...
<style lang="scss" scoped> // lang attribute will give you the ability to write SCSS in your single-file component
