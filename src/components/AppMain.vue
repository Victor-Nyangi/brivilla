...
<div>
    <section class="showcase">
        ...
        <video src="../assets/bg-video.mp4" muted loop autoplay></video>
...
<style lang="scss"> // lang attribute will give you the ability to write SCSS in your single-file component
